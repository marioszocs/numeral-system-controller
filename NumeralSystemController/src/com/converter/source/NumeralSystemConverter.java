...
public class NumeralSystemConverter {
	...
	protected static boolean isDigitInRadixAtLeast10(char digit, int radix) {
		...
		if (Character.toUpperCase(digit) >= 'A' && Character.toUpperCase(digit) <= 'A' + radix - 11) {
			return true;
		}
	...
	public static boolean isDigitInRadix(char digit, int radix) {
		...
		return (radix < 10) ? isDigitInRadixBelow10(digit, radix) : isDigitInRadixAtLeast10(digit, radix);
	}
